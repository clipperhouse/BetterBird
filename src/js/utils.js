...
(function() {
  ...
  (function($) {
    ...
    attributeFn = function(j, name, value) {
      if (value) {
    ...
    return $.fn.incrementData = function(key, inc) {
      return this.data(key, this.data(key) + inc);
    };
  })(jQuery);

  String.prototype.remove = function(r) {
    return this.replace(r, "");
  };

  String.prototype.removePrefix = function(r) {
    return this.remove(/^bb\-/);
  };
